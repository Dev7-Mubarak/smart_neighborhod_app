                    ...
                    return StaggeredGrid.count(
                      ...
                      children: _conflictListDisplay.map((e) {
                        return StaggeredGridTile.fit(
                          ...
                          //               const SizedBox(height: 6),
                          //               Text(
                          //                 'تاريخ الجلسة: ${e.sessionDate != null ? DateFormat('yyyy-MM-dd').format(e.sessionDate!) : "تاريخ غير محدد"}',
                          //                 style: const TextStyle(
                          //                   fontSize: 14,
                          //                   color: Colors.black,
                          //                   fontWeight: FontWeight.w600,
                    ...
                    return const Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 16),
                          Text('جاري تحميل بيانات الإتفاقيات...'),
                        ],
                      ),
                    );
