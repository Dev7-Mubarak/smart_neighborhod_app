...
class SyncService {
  ...
  Future<SyncResult> performSync({
    ...
    try {
      ...
      _emitProgress(
        SyncProgress(stage: SyncStage.cleanup, message: 'Cleaning up...'),
      );
      ...
      _emitProgress(SyncProgress(stage: SyncStage.failed, message: error));
  ...
  Future<void> _cleanupSyncedDeletions() async {
    ...
    await db.delete(
      'residents',
      where:
          "sync_status = 'synced' AND deleted_at IS NOT NULL AND deleted_at < ?",
...
/// Sync stages
enum SyncStage { starting, uploading, downloading, cleanup, completed, failed }
