...
import 'package:smart_neighborhod_app/cubits/family_catgory_cubit/family_catgory_state.dart';
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(
                                      height: AppSize
                                          .spasingBetweenInputsAndLabale),
                                  BlocBuilder<FamilyCategoryCubit,
                                      FamilyCategoryState>(
                                    builder: (context, state) {
                                        ...
                                        onPressed: () {
                                          if (_formKey.currentState!
                                            ...
                                            Family family = Family(
                                              ...
                                              familyCatgoryId:
                                                  selectedFamilyCategory?.id ??
                                                      0,
                                              familyTypeId: _familyTypeId ?? 0,
                                              blockId: _blockId!,
                                              familyHeadId:
                                                  selectedFamilyHead?.id ?? 0,
                                            );
