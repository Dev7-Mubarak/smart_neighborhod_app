                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                            ...
                            onPrefixIconPressed: () {
                            forgetapasswordCubit.changeFirstPasswordVisibilty();
                            },
                          ),
                          const SizedBox(height: 8),
                          const Text(
                          ...
                          CustomTextFormField(
                            ...
                            suffixIcon: Icons.key,
                            obscureText: forgetapasswordCubit.SecondisPassword,
                            prefixIcon: forgetapasswordCubit.SecondprefixIcon,
                            onPrefixIconPressed: () {
                              forgetapasswordCubit.changeSecondPasswordVisibilty();
                            },
                          ),
                      ...
                      DefaultButton(
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            forgetapasswordCubit.sendNewPassword(FirstpasswordContoller.text);                              
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
