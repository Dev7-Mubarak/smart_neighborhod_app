                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                _buildCodeCircle(firstNumController, firstFocus,
                                    secondFocus),
                                _buildCodeCircle(secondNumController,
                                    secondFocus, thirdFocus),
                                _buildCodeCircle(thirdNumController, thirdFocus,
                                    fourthFocus),
                                _buildCodeCircle(
                        ...
                        builder: (context) => DefaultButton(
                          ...
                          onPressed: () {
                            if (formKey.currentState!.validate()) {
                              ...
                              Navigator.pushNamed(
                                  context, AppRoute.createNewPassword);
                            }
                          },
                          fontsize: 20,
                        ),
